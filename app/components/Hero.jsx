  ...
  return (
    <div className='w-full h-screen flex justify-center items-center relative overflow-hidden'>
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-40 right-32 w-24 h-24 bg-pink-400/20 rounded-full blur-lg animate-bounce"></div>
        <div className="absolute bottom-32 left-1/4 w-40 h-40 bg-blue-400/15 rounded-full blur-2xl animate-pulse"></div>
        <div className="absolute bottom-20 right-20 w-28 h-28 bg-purple-400/20 rounded-full blur-lg animate-bounce"></div>
      </div>
      ...
      <div className="relative z-10 text-center">
        <div className='flex justify-center gap-8 mb-8'>
          <Link
            href="/projects"
            className="relative px-6 py-3 text-white font-medium rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 hover:border-white/40 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-white/25"
          >
            Projects
          </Link>
          <Link
        ...
        <div className="mb-8">
          <svg
            ...
            className="h-32 w-auto fill-white drop-shadow-lg"
          >
            <g>
